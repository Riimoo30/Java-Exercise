...
public class Main {
    ...
    private static void exercise1() {
        ...
        //adding 2 to our new int value
        ourNumberAsInt += 2;
        //printing the new int value
        System.out.println(ourNumberAsInt);
        //converting again the int into a String
        ourNumberStr = String.valueOf(ourNumberAsInt);
    ...
    private static void exercise2() {
        ...
        //The char index stands for the position of the character, the 0 meaning the first ecc.
    ...
    private static void exercise4() {
        ...
        startStr = String.valueOf(startNum);
        //concatenating the string
        String concString = startStr + startStr;
        System.out.println(concString);
        //converting the new concatenated string into a double
        double doubleNum = Double.valueOf(concString);
        //dividing by 3.5
        doubleNum /= 3.5;
        //printing using Math.floor to get no decimals
